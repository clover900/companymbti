 ...
 * 2. 진행 상태 표시 바 구현 (상단 배치)
 * 3. MBTI 결과 계산 로직 구현
 * 4. 결과 화면에 MBTI 유형과 키워드 클라우드 표시
 ...
 *   * 상단 진행바
 *   * 질문 텍스트
 *   * 선택지 버튼 2개 (호버 시 파란색 테두리)
 * - 결과 화면 구성:
 *   * MBTI 결과 표시
 *   * 키워드 클라우드 (랜덤 크기, 호버 효과)
 *   * "다시 해보기" 버튼 (파란색 계열)
 * 
 * 스타일 가이드:
 * - 기본 폰트 크기: 
 ...
 * 
 * 주의사항:
 * - 이 파일의 현재 구현은 완성된 상태이며 추가 수정 시 주의 필요
 * - 모바일 최적화된 레이아웃 유지할 것
 * - 키워드 클라우드의 랜덤 효과는 유지할 것
 * - 첫 화면의 이미지는 public 폴더의 image 75.png 사용
 */
